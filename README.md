...
Карта гипотез — это инструмент стратегического планирования, который помогает структурированно описать цели, субъектов, гипотезы о способах достижения целей, задачи для проверки гипотез и метрики для измерения результатов.

Данная библиотека предоставляет готовые макросы PlantUML для создания профессиональных диаграмм Карт гипотез с автоматическими связями и системой приоритетов.
...
- `my.puml` - сложная карта с группировкой и ветвлениями
